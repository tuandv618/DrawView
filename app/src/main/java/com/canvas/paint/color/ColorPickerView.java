...
package com.canvas.paint.color;
...
import com.canvas.paint.color.flag.FlagMode;
import com.canvas.paint.color.flag.FlagView;
import com.canvas.paint.color.listeners.ColorEnvelopeListener;
import com.canvas.paint.color.listeners.ColorListener;
import com.canvas.paint.color.listeners.ColorPickerViewListener;
import com.canvas.paint.color.preference.ColorPickerPreferenceManager;
import com.canvas.paint.color.sliders.AlphaSlideBar;
...
public class ColorPickerView extends FrameLayout implements LifecycleObserver {
  ...
  private void onCreate() {
    ...
    if (selectorDrawable != null) {
      ...
      selector.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.color_picker_view_wheel));
    }
