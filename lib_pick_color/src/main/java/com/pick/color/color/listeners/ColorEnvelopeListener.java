...
package com.pick.color.color.listeners;

import com.canvas.paint.color.ColorEnvelope;
import com.canvas.paint.color.listeners.ColorPickerViewListener;

/**
 * ColorEnvelopeListener is invoked whenever {@link com.canvas.paint.color.ColorPickerView} is
 * triggered.
 */
public interface ColorEnvelopeListener extends ColorPickerViewListener {
  /**
   * invoked by {@link com.canvas.paint.color.ColorPickerView}.
   *
