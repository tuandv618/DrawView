...
import com.canvas.paint.color.ActionMode;
...
//    canvas.drawRect(0, 0, width, height, borderPaint);
    float cornerRadius = height/2f; // hoặc giá trị tùy chỉnh cho độ bo tròn

// Vẽ hình chữ nhật với góc tròn
    canvas.drawRoundRect(0f, 0f, width, height, cornerRadius, cornerRadius, colorPaint);
